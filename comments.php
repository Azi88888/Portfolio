	...
	<div class="row align-center">
		<div class="small-12 medium-10 large-7 columns">
			<h4 class="comments-title">
				<?php
					comments_number( esc_html__( '0 Comments', 'werkstatt' ), esc_html__( '1 Comment', 'werkstatt' ), esc_html__( '% Comments', 'werkstatt' ) );
				?>
			</h4>
...
<?php
	...
	$defaults = array(
		...
		'must_log_in'          => '<p class="must-log-in">' . sprintf(
			wp_kses(
				__( 'You must be <a href="%s">logged in</a> to post a comment.', 'werkstatt' ),
				array(
					'a' => array(
						'href'  => array(),
						'title' => array(),
		...
		'logged_in_as'         => '<p class="logged-in-as">' . sprintf(
			wp_kses(
				__( 'Logged in as <a href="%1$s">%2$s</a>. <a href="%3$s" title="Log out of this account">Log out?</a>', 'werkstatt' ),
				array(
					'a' => array(
						'href'  => array(),
						'title' => array(),
